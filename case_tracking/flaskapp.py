...
def process():
    try:
        df_big_name = request.form['df_big']
        df_small_name = request.form['df_small']
        save_location = request.form['save_location']
        
        # Logic to fetch the actual dataframes (you may need to adjust based on how you fetch them)
        df_big = pd.read_excel(df_big_name)
        df_small = pd.read_excel(df_small_name)
        
        # Your existing case_tracker function logic here (modified to use df_big, df_small, and save_location)
        # I'll simulate the function call to show how you might structure it
        
        # For demonstration purposes:
        result = bring_case(df_big, df_small, save_location)
...
def bring_case(df_big, df_small, save_location):
    # Your existing function logic here, modified to use df_big, df_small, and save_location
    # For demonstration, I'll return a mock result
    import pandas as pd
    import numpy as np
    import os
